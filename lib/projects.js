export const projects = [
  {
    ...
    cover: '/assets/thumbnails/bai-1.webp',
    coverAlt: 'Trang đầu bài thực hành thao tác cơ bản với tệp tin và thư mục',
    document: '/documents/bai-1.pdf',
    accent: '#7096D1',
    tags: ['Windows', 'File Explorer', 'Kỹ năng số'],
    intro: 'Bài thực hành đầu tiên tập trung vào những thao tác nền tảng nhất khi làm việc với dữ liệu. Ngọc Anh thực hiện từng bước trên File Explorer và lưu lại ảnh minh chứng theo đúng thứ tự.',
    sections: [
      {
        type: 'text',
      ...
      },
      {
        ...
        paragraphs: [
          'Bài thực hành giúp Ngọc Anh hình thành quy trình quản lý dữ liệu có trật tự và hiểu rõ hậu quả của từng thao tác xóa.',
  ...
  },
  {
    ...
    cover: '/assets/thumbnails/bai-2.webp',
    coverAlt: 'Trang đầu báo cáo tìm kiếm và đánh giá thông tin học thuật',
    document: '/documents/bai-2.pdf',
    accent: '#334EAC',
    tags: ['Hallyu', 'Nghiên cứu', 'Harvard'],
    intro: 'Đề tài kết nối trực tiếp với ngành học của Ngọc Anh: Ngôn ngữ và Văn hóa Hàn Quốc. Bài báo cáo tập trung vào việc xây dựng phạm vi tìm kiếm, phân nhóm tài liệu và đánh giá độ tin cậy của từng loại nguồn.',
    sections: [
      {
        type: 'text',
      ...
      },
      {
        ...
        title: 'Kết quả và cảm nhận',
        paragraphs: [
          'Qua bài tập, Ngọc Anh rèn được thói quen không dừng ở việc “tìm thấy” thông tin mà còn phải kiểm tra tác giả, cơ quan xuất bản, phương pháp, mức độ cập nhật và khả năng khái quát.',
  ...
  },
  {
    ...
    cover: '/assets/thumbnails/bai-3.webp',
    coverAlt: 'Trang đầu báo cáo tối ưu hóa prompt trong các tác vụ học tập',
    document: '/documents/bai-3.pdf',
    accent: '#7AB4F9',
    tags: ['Prompt engineering', 'AI', 'Tư duy phản biện'],
    intro: 'Ngọc Anh thử nghiệm ba cấp độ prompt trên ba loại nhiệm vụ học tập khác nhau để quan sát cách ngữ cảnh, vai trò và định dạng đầu ra ảnh hưởng đến chất lượng câu trả lời.',
    sections: [
      {
        type: 'text',
  ...
  },
  {
    ...
    cover: '/assets/thumbnails/bai-4.webp',
    coverAlt: 'Trang đầu báo cáo sử dụng công cụ hợp tác trực tuyến cho dự án nhóm',
    document: '/documents/bai-4.pdf',
    accent: '#6DD3F7',
    tags: ['Trello', 'Google Workspace', 'Discord'],
    intro: 'Trong dự án thuyết trình về “Vật chất và Ý thức”, Ngọc Anh giữ vai trò thành viên cốt lõi, thiết lập không gian làm việc, theo dõi tiến độ và kết nối thông tin giữa các thành viên.',
    sections: [
      {
        type: 'text',
        title: 'Vai trò cá nhân',
        paragraphs: [
          'Ngọc Anh chịu trách nhiệm tổ chức hệ thống công cụ chung, chuẩn hóa cách lưu trữ tài liệu và duy trì luồng trao đổi để nhóm hoàn thành bài đúng hạn.',
      ...
      },
      {
        ...
        images: ['/assets/projects/4/img-004.png', '/assets/projects/4/img-006.png', '/assets/projects/4/img-010.png', '/assets/projects/4/img-012.png'],
        captions: ['Cấu trúc thư mục', 'Quyền truy cập', 'Tài liệu cộng tác', 'Trao đổi bằng bình luận']
      },
      {
        type: 'galleryGroup',
        ...
        images: ['/assets/projects/4/img-014.png', '/assets/projects/4/img-008.png'],
        captions: ['Hệ thống kênh', 'Tài khoản và không gian nhóm']
      },
      {
        type: 'table',
        title: 'Thách thức và cách xử lý',
        columns: ['Thách thức', 'Giải pháp của Ngọc Anh'],
        rows: [
  ...
  },
  {
    ...
    cover: '/assets/thumbnails/bai-5.webp',
    coverAlt: 'Trang đầu báo cáo sử dụng AI tạo sinh để hỗ trợ sáng tạo nội dung',
    ...
    sections: [
      ...
      },
      {
        ...
        description: 'Gemini hỗ trợ tạo cấu trúc bốn phần: tư duy, lộ trình, công cụ và bí kíp. Ngọc Anh rút gọn các đoạn dài và bổ sung Personal Learning Tips từ trải nghiệm bản thân.',
      ...
      },
      {
        ...
        images: ['/assets/projects/5/img-008.png', '/assets/projects/5/img-010.png'],
        captions: ['Minh họa sinh viên', 'Minh họa công cụ học tập']
      },
      {
        type: 'galleryGroup',
        ...
        images: ['/assets/projects/5/img-012.png', '/assets/projects/5/img-013.png'],
        captions: ['Không gian thiết kế', 'Phiên bản đang hoàn thiện']
      },
      {
        type: 'heroImage',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Ngọc Anh ước tính AI giúp tiết kiệm khoảng 70% thời gian tìm ý và tạo minh họa, nhưng phần cá nhân hóa và quyết định cuối cùng vẫn do người thực hiện chịu trách nhiệm.'
        ]
      }
    ]
  },
  {
    ...
    cover: '/assets/thumbnails/bai-6.webp',
    coverAlt: 'Trang đầu báo cáo sử dụng AI có trách nhiệm trong học tập và nghiên cứu',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Ngọc Anh kiểm tra tính logic, đối chiếu số liệu với tài liệu gốc và biên tập lại văn phong để tránh kiểu trả lời máy móc.',
